...
**AgentAgent2** is a meta-agent that **designs and builds other AI a0gents** to	 a verifieded quality bar. It is the successor to AgentAgent (v1), which produced only design documents. AgentAgent2 designs **and** builds **and** proves: it emits runnable, tested, linted, typed agent code plus the validated design that justifies it.
